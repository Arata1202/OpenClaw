...
resource "aws_iam_user" "openclaw_lambda_iam_user" {
  name = "openclaw_lambda_iam_user"
}

resource "aws_iam_user_policy" "openclaw_lambda_iam_user_policy" {
  name = "openclaw_lambda_iam_user_policy"
  user = aws_iam_user.openclaw_lambda_iam_user.name
